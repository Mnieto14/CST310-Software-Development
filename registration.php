...
?>
<!DOCTYPE html>
<html lang="en"><head><title>Registration Employee Portal</title>
...
<input type="text" class="form-control" id="inputsalary" name="salary" required>
</div>
<div class="form-group col-md-3" id="no-padding-right">
<label for="inputSSN">SSN</label>
<input type="text" class="form-control" id="inputSSN" name="ssn" required>
</div>
